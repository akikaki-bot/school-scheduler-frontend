...
export function AdminSidebarComopnent({ children }: { children: ReactNode }) {
            ...
            <aside id="default-sidebar" className={`fixed top-[64px] left-0 z-40 w-64 h-screen transition-transform ${isOpen ? "-translate-x-0" : "-translate-x-full"} sm:translate-x-0`} aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link onClick={() => setOpen(false)} href={`/`} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <HomeIcon />
                                <span className="ms-3">メインページに戻る</span>
                            </Link>
                        </li>
                        {
                            ...
                            (
                                <li key={index}>
                                    <Link onClick={() => setOpen(false)} href={`/dashboard/admin/${menu.href}`} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        {
